...
export default function Disclaimer() {
  ...
  return (
    ...
    >
      <p>The FDA encourages veterinarians and animal owners to report adverse drug experiences and product defects
      ...
      <p>This database should not be the sole source of information for clinical decision-making or other assumptions
        ...
        underreported.</p>
      <p>CVM supplies AER data to openFDA.gov so that the public can access information about clinical signs that have
